    ...
    <div className='flex flex-col gap-2 px-2 md:px-0'>
      <div>
        <div className='flex flex-col gap-[36px]'>
          <p>
            Etwa zwei Kilometer Luftlinie entfernt sehen und hören wir auch oft
            den Atlantik. An die nahen Strände kommt man bergabwärts zu Fuß, per
            Fahrrad oder Auto. An Kersiny, Mesperleuc, Gwendrez und vielen
            Stränden weiter nach Norden oder Süden findet jeder seinen idealen
            Ort zum Chillen im Sand, zum Surfen, Segeln, Standup-paddeln ...
          </p>
          <div className='border-t-[1px] border-accent'></div>

          <div className='mb-4 flex flex-col  gap-1 text-main_80'>
            <h1 className='mb-4 text-2xl'>Adresse</h1>
