  ...
  return (
    <div>
      <div className='flex flex-col gap-[36px] px-2 md:px-0'>
        <div>
          <h1 className='mb-4 text-xl '>Hausregeln</h1>
        ...
        <div>
          <h1 className='mb-4 text-xl'>Stornierungsbedingungen</h1>
          <p>
            Vollständige Rückerstattung für Stornierungen innerhalb 48 Stunden
            nach Buchung oder bis 30 Tage vor dem Check-in. Danach wird bis
            7 Tage vor dem Check-in eine Rückerstattung in Höhe von 50 %
            ausgegeben. Anschließend wird keine Rückerstattung mehr ausgegeben.
          </p>
        </div>
      </div>
    </div>
